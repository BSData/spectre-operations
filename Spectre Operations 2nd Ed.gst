...
--Mines and IEDS may well come along in updates if enough people want them.
...
If Handler killed, dog is removed from play.
      ...
      <categoryLinks>
        <categoryLink id="dacf-6e94-4f6c-57cf" name="Infantry" hidden="false" targetId="4fab-0383-704a-cd0d" primary="false"/>
      </categoryLinks>
      <entryLinks>
